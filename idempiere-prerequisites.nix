...
in {
  ...
  systemd.tmpfiles.rules = [
    ...
    # ZK root folder browser directory — the default path Folder/FilePath
    # (DisplayType=FilePath) pickers open at, instead of IDEMPIERE_HOME.
    # See: ZK_ROOT_FOLDER_BROWSER SysConfig (idempiere-golive-deploy) and
    # https://wiki.idempiere.org/en/Securing_iDempiere#ZK_ROOT_FOLDER_BROWSER
    "d /opt/idempiere-folder-browser 0750 ${idempiere.user} ${idempiere.group} -"
